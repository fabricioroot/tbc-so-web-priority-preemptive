...
public class Calculator {
     ...
     * the algorithm Preemptive Priority Scheduling (in Portuguese: Por Prioridade Preemptivo).
     */
    ...
    /* This method calculates the waiting time and the turn around of the process that is going to be executed according
     * the algorithm Preemptive Priority Scheduling (in Portuguese: Por Prioridade Preemptivo), but only for those which are in the wainting processes queue.
     */
    public Vector<Process> waitingTimeAndTurnAround_2 (Vector<Process> waitingProcesses, Vector<Process> reportBase, int time) {
        ...
        // It finds the position of process with highest priority
