...
public class MainScreen extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabelShowPriority = new javax.swing.JLabel();
        ...
        jLabelShowPriority.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabelShowPriority.setPreferredSize(new java.awt.Dimension(4, 15));
            ...
            .addGroup(jPanelAnimationLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAnimationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelAnimationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jLabelShowPriority, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanelAnimationLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAnimationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelAnimationLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanelWaitingProcesses, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelAnimationLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabelShowPriority, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jPanelProcesses, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButtonIntroductionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIntroductionActionPerformed
        final String TEXT_BASE_INTRODUCTION = "\n" +
                                              ...
                                              "*Este software educativo trata da política \"Por Prioridade Preemptiva\".\n" +
        ...
        final String TEXT_BASE_ALGORITHM = "* ESTA FUNÇÃO DEVE SER EXECUTADA EM PARALELO COM A FUNÇÃO 'criarProcesso' \n\n" +
                                           "funcao porPrioridadePreemptiva (referência de vetor<TAD_Processo> listaDeProntos, referência de vetor<TAD_Processo> listaDeEspera,\n" +
                                           "                                                  TAD_Processo processoNovo, inteiro prioridadeMaxima) : TAD_Processo\n" +
                                           "inicio\n" +
                                           "    TAD_Processo processo;\n" +
                                           "    inteiro aux := 0;\n\n" +
                                           
                                           "    se (processoNovo <> null)\n" +
                                           "        porPrioridadePreemptiva := processoNovo;\n" +
                                           "    Fim se\n" +
                                           "    senão\n" +
                                           "        se (listaDeEspera não está vazia)\n" +
                                           "            processo := listaDeEspera.último elemento;\n" +
                                           "            porPrioridadePreemptiva := processo;\n" +
                                           ...
                                           "inicio\n\n" +
                                           "    se ('função porPrioridadePreemptiva' estiver sendo executada)\n" +
                                           "        se (processoNovo.prioridade > porPrioridadePreemptiva.processo.prioridade)\n" +
                                           "            pára a execução da 'função porPrioridadePreemptiva';\n" +
                                           "            adiciona 'porPrioridadePreemptiva.processo' no fim da lista 'listaDeEspera';\n" +
                                           "            porPrioridadePreemptiva(listaDeProntos, listaDeEspera, processoNovo, prioridadeMaxima);\n" +
                                           "        Fim se\n" +
                                           "        senão\n" +
    ...
    private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStartActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Para criar um processo, digite seu tempo de burst, sua prioridade e clique em 'Criar'.\n" +
                ...
                "                                     ou em espera (Blocos Azuis) para ver informações sobre eles.", "DICA", JOptionPane.INFORMATION_MESSAGE);
            ...
            if( (this.jTextFieldPriority.getText().equals("")) || ((Integer.parseInt(this.jTextFieldPriority.getText()) < MINIMUM)) || ((Integer.parseInt(this.jTextFieldPriority.getText()) > MAXIMUM)) ){
                ...
                if(this.readyProcesses.size() <= 8) {
                    ...
                    if(this.st != null) {
                        ...
                        if ((this.st.getJButtonOkNextStep().isVisible() == true) && (this.st.getJProgressBarExecution().isVisible() != true)) {
                            ...
                            if (this.st.getJProgressBarExecution().isVisible() == true) {
                                ...
                                Process tempAux = new Process();
                                
                                if (this.st.getProcess() != null) {
                                    tempAux = new Process(this.st.getProcess());
                                }

                                if (this.st.getNewProcess() != null) {
                                    tempAux = new Process(this.st.getNewProcess());
                                }
                                
                                if (process.getPriority() > tempAux.getPriority()){
                                    Process processAux;
                                    if (this.st.getNewProcess() != null) {
                                        processAux = new Process(this.st.getNewProcess());
                                    }
                                    else {
                                        processAux = new Process(this.st.getProcess());
                                    }
                                    JOptionPane.showMessageDialog(null, "Processo criado com sucesso!\n" +
                                            "OBSERVAÇÕES: 1) o processo criado (P" + process.getId() +  ") possui prioridade MAIOR que a prioridade do processo escalonado (P" + processAux.getId() + ");\n" +
                                    ...
                                    this.newProcess = new Process(process);
    ...
    private void jButtonAlgorithmStepsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlgorithmStepsActionPerformed
        ...
        this.st = new AlgorithmStepsThread(this, this.jButtonAlgorithmSteps, this.jButtonReport, this.readyProcesses, this.waitingProcesses,
                                      ...
                                      this.jLabelShowBurstTime, this.jLabelShowCreationTime, this.jLabelShowPriority, this.jLabelTimeCounter,
                                      this.jLabelCPU, MAXIMUM, this.newProcess, this.jButtonOkNextStep);
    ...
    private void jButtonRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRestartActionPerformed
        ...
        this.jLabelShowPriority.setVisible(false);
    ...
    private void jButtonReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReportActionPerformed
        ...
        for(int i = 0; i <= (this.reportBaseTemp.size() - 1); i++) {
            report += "P" + this.reportBaseTemp.elementAt(i).getId() + ": tempo de burst = " + (int)this.reportBaseTemp.elementAt(i).getLifeTime() + ";  tempo na criação = " + (int)this.reportBaseTemp.elementAt(i).getCreationTime() + ";  prioridade = " + this.reportBaseTemp.elementAt(i).getPriority() + ";\n";
        }
    ...
    public void paintReadyProcesses(Vector<Process> processesQueue) {
        ...
        for(int i = 0; i <= (processesQueue.size() - 1); i++) {
            ...
            block.setToolTipText("Tempo de burst = " + String.valueOf((int)processesQueue.elementAt(i).getLifeTime()) + ";  Tempo na criação = " + String.valueOf((int)processesQueue.elementAt(i).getCreationTime()) + ";  Prioridade = " + String.valueOf(processesQueue.elementAt(i).getPriority()));
    ...
    public void paintWaitingProcesses(Vector<Process> processes) {
        ...
        for(int i = 0; i <= (processes.size() - 1); i++) {
            ...
            block.setToolTipText("Tempo de burst restante = " + String.valueOf((int)processes.elementAt(i).getLifeTime()) + ";  Prioridade = " + String.valueOf(processes.elementAt(i).getPriority()));
    ...
    private javax.swing.JLabel jLabelShowPriority;
