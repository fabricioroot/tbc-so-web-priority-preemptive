...
import manager.PriorityPreeAlgorithm;
...
public class AlgorithmStepsThread implements Runnable {
    ...
    public AlgorithmStepsThread(MainScreen mainScreen, JButton jButtonAlgorithmSteps, JButton jButtonReport, Vector<Process> readyProcesses, Vector<Process> waitingProcesses,
                                ...
                                JLabel jLabelShowBurstTime,JLabel jLabelShowCreationTime, JLabel jLabelShowPriority, JLabel jLabelTimeCounter, JLabel jLabelCPU, int MAXIMUM,
                                Process newProcess, JButton jButtonOkNextStep){
        ...
        this.jLabelShowPriority = jLabelShowPriority;
    ...
    public void run() {
        ...
        this.jLabelShowPriority.setVisible(true);
        ...
        if (this.newProcess != null) {
            ...
            block4.setToolTipText("Tempo de burst = " + String.valueOf((int)newProcess.getLifeTime()) + ";  Prioridade = " + String.valueOf((int)newProcess.getPriority()));
            ...
            this.jLabelShowPriority.setText("Prioridade de P" + String.valueOf(this.newProcess.getId()) + " = " + String.valueOf(this.newProcess.getPriority()));
            ...
            this.jLabelShowPriority.setText("");
            ...
            if(!this.waitingProcesses.isEmpty()) {
                ...
                block4.setToolTipText("Tempo de burst = " + String.valueOf((int)this.process.getLifeTime()) + ";  Prioridade = " + String.valueOf(this.process.getPriority()));
                this.jProgressBarExecution.setVisible(true);
                ...
                this.jLabelShowPriority.setText("Prioridade de P" + String.valueOf(this.process.getId()) + " = " + String.valueOf(this.process.getPriority()));
                ...
                if (!this.readyProcesses.isEmpty()) {
                    ...
                    PriorityPreeAlgorithm algorithm = new PriorityPreeAlgorithm();
                    ...
                    this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.readyProcesses.elementAt(0).getPriority()));
                    do {
                        if (this.isJButtonOkClicked) {
                            this.jButtonOkNextStep.setVisible(false);
                        }
                    ...
                    this.jLabelShowCreationTime.setText("Prioridade em \"j\" = " + String.valueOf(this.readyProcesses.elementAt(0).getPriority()));
                    block.setText("i");
                    ...
                    if (positionsPossibleProcesses.size() > 1) {
                        ...
                        for(j = 1; j <= (positionsPossibleProcesses.size() - 1); j++) {
                            ...
                            this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.readyProcesses.elementAt(i).getPriority()));
                            i++;
                            ...
                            this.jLabelShowCreationTime.setText("Prioridade em \"i\" = " + String.valueOf(this.readyProcesses.elementAt(positionsPossibleProcesses.elementAt(j)).getPriority()));
                    ...
                    if(positionsPossibleProcesses.lastElement() < (this.readyProcesses.size() - 1)) {
                        ...
                        this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.readyProcesses.elementAt(j).getPriority()));
                        j++;
                    ...
                    this.jLabelShowPriority.setText("Prioridade de P" + String.valueOf(process.getId()) + " = " + String.valueOf(process.getPriority()));
